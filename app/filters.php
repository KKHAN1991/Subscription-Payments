...
Route::filter('subscribed', function ()
{
	...
	if (Auth::check() && !Auth::user()->subscribed())
	{
		return Redirect::action('subscription')
			->with('notice', 'You need to be subscribed to do that.');
	}
});
...
Route::filter('plan.large', function ()
{
	...
	{
		return Redirect::action('subscription')->with('notice', 'You need to be on the big plan to access this page');
	}
});
